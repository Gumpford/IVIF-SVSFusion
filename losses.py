...
class L_Intensity_Max_RGB(nn.Module):
    ...
    def forward(self, image_infrared, image_visible, image_fused, max_mode="l1"):
...
def max_gradint(ir_image, vis_image, out_image):
    ...
    # edge_detect2 = torch.abs(edge_detect2)
...
def max_intensity(ir_image, vi_image):
    max_image = torch.maximum(ir_image, vi_image)
    return max_image